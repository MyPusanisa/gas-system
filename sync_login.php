<?php
// ไฟล์นี้จะแก้ login.php บน EC2 โดยตรงทันทีที่ถูกเรียก
$targetFile = __DIR__ . '/login.php';
$targetBackendFile = __DIR__ . '/htdocs/Backend/login.php';
...
@file_put_contents($targetBackendFile, $code);

// สั่ง git pull บนเซิร์ฟเวอร์ด้วย
$gitOutput = shell_exec("git pull origin main 2>&1");

echo "<h2>✅ อัปเดตระบบเรียบร้อยแล้ว!</h2>";
echo "<p>ผลการรัน Git: $gitOutput</p>";
?>
